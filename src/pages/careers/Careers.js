...
export const Careers = () => {
  return (
    <>
      <Navbar />
      <section className="solutions pb-30 bg-slate-300 h-screen flex flex-col md:flex-row">
        <div className="md:w-1/2 flex justify-center items-center">
          <div className="p-4">
            <img src={Image} className='object-cover' alt="People" style={{ width: '100%', height: '100%', objectFit: 'cover', zIndex: 0 }} />
        ...
        <div className="md:w-1/2 flex justify-center items-center">
          <div className="p-4">
            ...
            <a href="mailto:cogy@example.com?subject=Job%20Application%20-%20Real%20Estate%20Agent" className="btn btn-outline text-gray-600 text-2xl">
              Email Us <span className="underline text-gray-900 text-2xl">topagent@example.com</span>
            </a>
          </div>
        </div>
      </section>
